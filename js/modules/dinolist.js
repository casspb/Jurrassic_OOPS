...
const dinosaurs = {
    ...
    Baryonyx: new DangerousDinosaur("Baryonyx", "3 meters", "9 meters", "Carnivorous", "Aggressive, Territorial", "Bar-ee-oh-nix", "images/baryonyx.webp", "Baryonyx was a carnivorous dinosaur and the first fish-eating dinosaur in history."),
    ...
    IndominusRex: new DangerousDinosaur("Indominus Rex", "6 meters", "15 meters", "Carnivorous", "Cunning, Deadly", "In-doh-min-us Rex", "images/indominusrex.webp", "The Indominus Rex is a manmade hybrid species, made using Tyrannosaurus rex genomes and the DNA of other theropods."),
    Metricanthosaurus: new DangerousDinosaur("Metricanthosaurus", "3 meters", "8 meters", "Carnivorous", "Aggressive, Independent", "Met-ri-can-tho-sore-us", "images/metricanthosaurus.webp","Metriacanthosaurus gets its name for its backbones, which have spines on top that are taller than in many meat-eaters."),
    ...
    Mosasaurus: new DangerousDinosaur("Mosasaurus", "6 meters", "18 meters", "Carnivorous", "Apex Predator", "Mo-sah-sore-us", "images/mosasaurus.webp", "While they lived in the same period, Mosasaurus were NOT dinosaurs. But instead, they were a variety of Lizard, that had adapted to the way of the ocean."),
    ...
    Pteranodon: new DangerousDinosaur("Pteranodon", "1.8 meters", "6 meters", "Carnivorous", "Gliding, Observant", "Ter-an-oh-don", "images/pteranodon.webp", "Pteranodon was a flying reptile that lived during the time of the dinosaurs - it was not a dinosaur, but was a close relative of the dinosaurs."),
    ...
    Suchomimus: new DangerousDinosaur("Suchomimus", "3 meters", "11 meters", "Carnivorous", "Fish-eating, Territorial", "Sook-oh-my-mus", "images/suchomimus.webp", "Unlike most giant theropods, Suchomimus had a very long, low snout and narrow jaws studded with some 100 teeth, not very sharp and curving slightly backward. The tip of the snout was enlarged and carried a rosette of longer teeth."),
