...
var _dinoscrollJs = require("./modules/dinoscroll.js");
var _dinolistJs = require("./modules/dinolist.js");
(0, _dinoscrollJs.dinoscroll)();
(0, _dinolistJs.dinolist)();

},{"./modules/dinoscroll.js":"ecAxk","./modules/dinolist.js":"ggFgC"}],"ecAxk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "dinoscroll", ()=>dinoscroll);
function dinoscroll() {
...
},{}],"ggFgC":[function(require,module,exports,__globalThis) {
...
//       "Velociraptor"
//   );
parcelHelpers.export(exports, "dinolist", ()=>dinolist);
var _vue = require("vue");
var _dinosaurJs = require("./dinosaur.js");
var _gsapJs = require("./gsap.js"); // Import the animation function
var _ankylosaurusWebp = require("url:../../images/ankylosaurus.webp");
var _ankylosaurusWebpDefault = parcelHelpers.interopDefault(_ankylosaurusWebp);
var _apatosaurusWebp = require("url:../../images/apatosaurus.webp");
var _apatosaurusWebpDefault = parcelHelpers.interopDefault(_apatosaurusWebp);
var _baryonyxWebp = require("url:../../images/baryonyx.webp");
var _baryonyxWebpDefault = parcelHelpers.interopDefault(_baryonyxWebp);
var _edmontosaurusWebp = require("url:../../images/edmontosaurus.webp");
var _edmontosaurusWebpDefault = parcelHelpers.interopDefault(_edmontosaurusWebp);
var _gallimimusWebp = require("url:../../images/gallimimus.webp");
var _gallimimusWebpDefault = parcelHelpers.interopDefault(_gallimimusWebp);
var _indominusRexWebp = require("url:../../images/indominusRex.webp");
var _indominusRexWebpDefault = parcelHelpers.interopDefault(_indominusRexWebp);
var _metricanthosaurusWebp = require("url:../../images/metricanthosaurus.webp");
var _metricanthosaurusWebpDefault = parcelHelpers.interopDefault(_metricanthosaurusWebp);
var _microceratusWebp = require("url:../../images/microceratus.webp");
var _microceratusWebpDefault = parcelHelpers.interopDefault(_microceratusWebp);
var _mosasaurusWebp = require("url:../../images/mosasaurus.webp");
var _mosasaurusWebpDefault = parcelHelpers.interopDefault(_mosasaurusWebp);
var _pachycephalosaurusWebp = require("url:../../images/pachycephalosaurus.webp");
var _pachycephalosaurusWebpDefault = parcelHelpers.interopDefault(_pachycephalosaurusWebp);
var _parasaurolophusWebp = require("url:../../images/parasaurolophus.webp");
var _parasaurolophusWebpDefault = parcelHelpers.interopDefault(_parasaurolophusWebp);
var _pteranodonWebp = require("url:../../images/pteranodon.webp");
var _pteranodonWebpDefault = parcelHelpers.interopDefault(_pteranodonWebp);
var _stegosaurusWebp = require("url:../../images/stegosaurus.webp");
var _stegosaurusWebpDefault = parcelHelpers.interopDefault(_stegosaurusWebp);
var _suchomimusWebp = require("url:../../images/suchomimus.webp");
var _suchomimusWebpDefault = parcelHelpers.interopDefault(_suchomimusWebp);
var _triceratopsWebp = require("url:../../images/triceratops.webp");
var _triceratopsWebpDefault = parcelHelpers.interopDefault(_triceratopsWebp);
const dinosaurs = {
    Ankylosaurus: new (0, _dinosaurJs.Dinosaur)("Ankylosaurus", "1.8 meters", "7.6 meters", "Herbivorous", "Defensive, Stoic, Loyal", "An-kee-loh-sore-us", (0, _ankylosaurusWebpDefault.default), "Ankylosaurus was as large as a military tank and nearly as hard to attack, even though it was slow."),
    Apatosaurus: new (0, _dinosaurJs.Dinosaur)("Apatosaurus", "4.6 meters", "21 meters", "Herbivorous", "Gentle, Slow-moving", "A-pa-toh-sore-us", (0, _apatosaurusWebpDefault.default), "Scientists have formulated that the apatosaurus bones resembled modern-day birds. These dinosaurs had hollow bones that helped them to balance their weight equally."),
    Baryonyx: new (0, _dinosaurJs.DangerousDinosaur)("Baryonyx", "3 meters", "9 meters", "Carnivorous", "Aggressive, Territorial", "Bar-ee-oh-nix", (0, _baryonyxWebpDefault.default), "Baryonyx was a carnivorous dinosaur and the first fish-eating dinosaur in history."),
    Edmontosaurus: new (0, _dinosaurJs.Dinosaur)("Edmontosaurus", "3 meters", "12 meters", "Herbivorous", "Social, Alert", "Ed-mon-toh-sore-us", (0, _edmontosaurusWebpDefault.default), "Edmontosaurus was named from a fossil found in the Horseshoe Canyon Formation, in Alberta, Canada."),
    Gallimimus: new (0, _dinosaurJs.Dinosaur)("Gallimimus", "2 meters", "6 meters", "Omnivorous", "Fast, Skittish", "Gal-ee-mime-us", (0, _gallimimusWebpDefault.default), "Its brain was the size of a golf ball."),
    IndominusRex: new (0, _dinosaurJs.DangerousDinosaur)("Indominus Rex", "6 meters", "15 meters", "Carnivorous", "Cunning, Deadly", "In-doh-min-us Rex", (0, _indominusRexWebpDefault.default), "The Indominus Rex is a manmade hybrid species, made using Tyrannosaurus rex genomes and the DNA of other theropods."),
    Metricanthosaurus: new (0, _dinosaurJs.DangerousDinosaur)("Metricanthosaurus", "3 meters", "8 meters", "Carnivorous", "Aggressive, Independent", "Met-ri-can-tho-sore-us", (0, _metricanthosaurusWebpDefault.default), "Metriacanthosaurus gets its name for its backbones, which have spines on top that are taller than in many meat-eaters."),
    Microceratus: new (0, _dinosaurJs.Dinosaur)("Microceratus", "0.6 meters", "1 meter", "Herbivorous", "Curious, Playful", "My-crow-seh-ray-tus", (0, _microceratusWebpDefault.default), "Only juvenile fossils of this creature has been discovered, leaving scientists stumped on how large they would grow...until now."),
    Mosasaurus: new (0, _dinosaurJs.DangerousDinosaur)("Mosasaurus", "6 meters", "18 meters", "Carnivorous", "Apex Predator", "Mo-sah-sore-us", (0, _mosasaurusWebpDefault.default), "While they lived in the same period, Mosasaurus were NOT dinosaurs. But instead, they were a variety of Lizard, that had adapted to the way of the ocean."),
    Pachycephalosaurus: new (0, _dinosaurJs.Dinosaur)("Pachycephalosaurus", "2.5 meters", "4.5 meters", "Herbivorous", "Headstrong, Territorial", "Pack-ee-sef-ah-lo-sore-us", (0, _pachycephalosaurusWebpDefault.default), "This plant-eater had some special teeth. Although it had typical leaf-eating teeth tucked behind its short beak, Pachycelphalosaurus had other teeth in its cheeks. That might have helped it grind up things like nuts and fruit."),
    Parasaurolophus: new (0, _dinosaurJs.Dinosaur)("Parasaurolophus", "2.5 meters", "9 meters", "Herbivorous", "Social, Communicative", "Par-ah-saw-rol-oh-fus", (0, _parasaurolophusWebpDefault.default), "It is recognizable for the long, blunt crest protruding from the back of its skull. Although the exact purpose of this crest is a matter of some debate, aesthetic value, temperature regulation, and even vocalization have all been proposed as possible uses for the formation."),
    Pteranodon: new (0, _dinosaurJs.DangerousDinosaur)("Pteranodon", "1.8 meters", "6 meters", "Carnivorous", "Gliding, Observant", "Ter-an-oh-don", (0, _pteranodonWebpDefault.default), "Pteranodon was a flying reptile that lived during the time of the dinosaurs - it was not a dinosaur, but was a close relative of the dinosaurs."),
    Stegosaurus: new (0, _dinosaurJs.Dinosaur)("Stegosaurus", "4 meters", "9 meters", "Herbivorous", "Defensive, Slow", "Steg-oh-sore-us", (0, _stegosaurusWebpDefault.default), "As well as eating plants, stegosaurus supplemented its diet by intentionally swallowing small rocks. The rocks would have helped the stegosaurus to digest the vegetation in its stomach by moving around in there and helping to break up the foliage."),
    Suchomimus: new (0, _dinosaurJs.DangerousDinosaur)("Suchomimus", "3 meters", "11 meters", "Carnivorous", "Fish-eating, Territorial", "Sook-oh-my-mus", (0, _suchomimusWebpDefault.default), "Unlike most giant theropods, Suchomimus had a very long, low snout and narrow jaws studded with some 100 teeth, not very sharp and curving slightly backward. The tip of the snout was enlarged and carried a rosette of longer teeth."),
    Triceratops: new (0, _dinosaurJs.Dinosaur)("Triceratops", "3 meters", "9 meters", "Herbivorous", "Brave, Social", "Try-sair-ah-tops", (0, _triceratopsWebpDefault.default), "The large frill at the back of triceratops head was not just for show. It acted like a shield. The frill was made of solid bone and helped protect its neck and shoulders from attacks by predators like tyrannosaurus rex.")
};
function dinolist() {
    // Vue app
        ...
        mounted () {
            document.querySelectorAll("li").forEach((li)=>{
                li.addEventListener("click", ()=>{
                    ...
                    if (this.dinosaurs[dinoName]) this.displayDinoInfo(dinoName);
                });
            });
        }
    }).mount("#app");
...
},{"vue":"7KfG6","./dinosaur.js":"lTFXj","./gsap.js":"eJW9h","url:../../images/ankylosaurus.webp":"1I0jf","url:../../images/apatosaurus.webp":"8T8ag","url:../../images/baryonyx.webp":"bEH4W","url:../../images/edmontosaurus.webp":"dFyK0","url:../../images/gallimimus.webp":"g4MYl","url:../../images/indominusRex.webp":"nCDFA","url:../../images/metricanthosaurus.webp":"aVmh7","url:../../images/microceratus.webp":"fpwI1","url:../../images/mosasaurus.webp":"gXL73","url:../../images/pachycephalosaurus.webp":"19d0C","url:../../images/parasaurolophus.webp":"caGpg","url:../../images/pteranodon.webp":"7QxBU","url:../../images/stegosaurus.webp":"fKCcE","url:../../images/suchomimus.webp":"KSyLx","url:../../images/triceratops.webp":"5GF0Q","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7KfG6":[function(require,module,exports,__globalThis) {
/**
* vue v3.5.13
...
},{"@vue/runtime-dom":"jqTl0","@vue/compiler-dom":"422XV","@vue/shared":"9cuv0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jqTl0":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"422XV":[function(require,module,exports,__globalThis) {
/**
...
},{"@vue/compiler-core":"bjMyy","@vue/shared":"9cuv0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bjMyy":[function(require,module,exports,__globalThis) {
/**
...
},{"@vue/shared":"9cuv0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lTFXj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Dinosaur", ()=>Dinosaur);
parcelHelpers.export(exports, "DangerousDinosaur", ()=>DangerousDinosaur);
class Dinosaur {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eJW9h":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "animateDinoInfo", ()=>animateDinoInfo);
function animateDinoInfo() {
    const fadeDiv = document.querySelector(".gsap-fade");
    if (fadeDiv) gsap.fromTo(fadeDiv, {
        autoAlpha: 0,
        x: -20
    }, {
        autoAlpha: 1,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1I0jf":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("ankylosaurus.19ad8e9c.webp") + "?" + Date.now();

},{}],"8T8ag":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("apatosaurus.af76027b.webp") + "?" + Date.now();

},{}],"bEH4W":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("baryonyx.fa0c459d.webp") + "?" + Date.now();

},{}],"dFyK0":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("edmontosaurus.a93d2d6a.webp") + "?" + Date.now();

},{}],"g4MYl":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("gallimimus.60fbdf46.webp") + "?" + Date.now();

},{}],"nCDFA":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("indominusRex.80d9c491.webp") + "?" + Date.now();

},{}],"aVmh7":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("metricanthosaurus.ca2dc4ce.webp") + "?" + Date.now();

},{}],"fpwI1":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("microceratus.b54357f8.webp") + "?" + Date.now();

},{}],"gXL73":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("mosasaurus.8df776e1.webp") + "?" + Date.now();

},{}],"19d0C":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("pachycephalosaurus.90409f6a.webp") + "?" + Date.now();

},{}],"caGpg":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("parasaurolophus.479c00b1.webp") + "?" + Date.now();

},{}],"7QxBU":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("pteranodon.cd9c8dff.webp") + "?" + Date.now();

},{}],"fKCcE":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("stegosaurus.e7807e24.webp") + "?" + Date.now();

},{}],"KSyLx":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("suchomimus.3de60b5c.webp") + "?" + Date.now();
